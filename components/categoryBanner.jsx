  ...
  return (
       <div>
        ...
        <Carousel id="categoryCarousel">
          <Carousel.Item>
            <img src={art} alt="art" class="categoryPic"onClick={()=> props.handleClick(25)} />
            <Carousel.Caption>
              <h3 class="categoryCaption">Art</h3>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item>
            <img src={history} alt="history" class="categoryPic" onClick={()=> props.handleClick(23)} />
            <Carousel.Caption>
              <h3 class="categoryCaption">History</h3>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item>
            <img src={literature}  alt="literature" class="categoryPic" onClick={()=> props.handleClick(10)} />
            <Carousel.Caption>
              <h3 class="categoryCaption">Literature</h3>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item>
            <img src={math} alt="math" class="categoryPic" onClick={()=> props.handleClick(19)} />
            <Carousel.Caption>
              <h3 class="categoryCaption">Math</h3>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item>
            <img src={geography} alt="geography" class="categoryPic" onClick={()=> props.handleClick(22)} />
            <Carousel.Caption>
              <h3 class="categoryCaption">Geography</h3>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item>
            <img src={science} class="categoryPic" alt="science" onClick={()=> props.handleClick(17)} />
            <Carousel.Caption>
